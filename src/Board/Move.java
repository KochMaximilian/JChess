...
public abstract class Move {
    ...
    public static final class PawnPromotion extends Move {
        ...
        public PawnPromotion(final Move decorateMove) {
            super(decorateMove.getBoard(), decorateMove.getMovedPiece(), decorateMove.getDestinationCoord());
        ...
        @Override
        public boolean equals(final Object other) {
            return this == other || other instanceof PawnJump && (this.decorateMove.equals(other));
        }

        @Override
        public Board execute() {
            final Board pawnMoveBoard = this.decorateMove.execute();
