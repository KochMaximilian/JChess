...
public class Board {
    ...
    private Board(Builder builder) {
        ...
        this.whitePlayer = new WhitePlayer(this,whiteStandartMove,blackStandartMove);
        this.blackPlayer = new BlackPlayer(this,whiteStandartMove,blackStandartMove);
    ...
    // creates the initial position for the chess board
    ...
    // For building an instance of the board
